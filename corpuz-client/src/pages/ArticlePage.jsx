        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {articles.map((article, i) => (
              ...
              >
                {/*
                  ⬇️ LINE 74 (article #{i+1}: "{article.title}") — ARTICLE THUMBNAIL
                  ...
                  />
                  Recommended: 400x250px JPG, dramatic/action shot style
                */}
                <div className="flex h-44 items-center justify-center border-b border-[#FF2020]/10 bg-[#0a0a0a]">
                  <div className="text-center">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-[#FF2020]/40">
                      Article {i + 1}
                    </p>
                    <p className="mt-1 text-[10px] text-zinc-700">400×250px</p>
                  </div>
                </div>
                {/* ⬆️ END ARTICLE THUMBNAIL */}
